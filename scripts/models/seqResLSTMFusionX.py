...
####################################################################
class seqResLSTMFusionX(nn.Module):
    def __init__(self, args):
        super(seqResLSTMFusionX, self).__init__()
        ...
        if self.use_residual:
            ...
            self.resblock = ResidualBlock(in_channels=self.input_size*2, 
